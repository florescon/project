        ...
        <div class="col-span-8">
            ...
            <div class="flex items-center justify-between mt-6 article-actions-bar">
                <div class="flex gap-x-2">
                    ...
                    <a wire:click.prevent="addToCart({{ $pizza->id }})" href="#"
                        ...
                        <span wire:loading.remove wire:target="addToCart({{ $pizza->id }})">Agregar</span>
                        <span wire:loading wire:target="addToCart({{ $pizza->id }})">Cargando...</span>
                    </a>
